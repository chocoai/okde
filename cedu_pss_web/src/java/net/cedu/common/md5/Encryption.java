...
public class Encryption {
	...
	public static void main(String[] args) {
		 ...
		 System.out.println(new String(Hex.encode(b)));
		 System.out.println(decryptionString(Hex.decode("6ca71d9a7be6540f58a53373a82b4e41")));
		 System.out.println(encryption("root"));
		 System.out.println(decryption("4BF51672FF307EED0F412F3FEB5A81DE"));
