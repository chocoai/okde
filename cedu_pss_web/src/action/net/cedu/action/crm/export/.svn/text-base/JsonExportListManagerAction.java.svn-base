...
public class JsonExportListManagerAction extends BaseAction {
	 ...
	 * @throws Exception
	 */
	@Action(value = "excel_export_list_manager_student", results = { @Result(name = "success", type = "json", params = {
			"contentType", "text/json" }) })
	public String excelExportListManagerStudent() throws Exception {
		...
		userTask.setTitle("招生管理|学生跟进|学生信息查询|学生导出");
