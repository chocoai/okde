 ...
 *
 */
public class ExcelExportIndividualDailyDateAction extends BaseAction {
	...
	public String execute() throws Exception {
		...
		List reportList = individualDailyReport.statisticsByDate(mapParams,strParams,dateParams);
	...
	public HSSFWorkbook createExcel(List reportList, String title)
		...
		try {
			...
			createCell(wb, head, 0, "姓名",HSSFColor.GREY_25_PERCENT.index);
			createCell(wb, head, 1, "当日工作情况",HSSFColor.GREY_25_PERCENT.index);
