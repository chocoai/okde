...
/**
 * 招生返款申请（中心）显示可以返款的缴费单明细  2012-05-26 重构____学习中心、服务站合并计算返款
 * 
 * @author xiao
 *
 */
@ParentPackage("json-default")
public class JsonAddChannelRebateSpecialReviewShowAction extends BaseAction
{
	 ...
	 * @throws Exception
	 */
	@Action(value = "count_channel_rebate_review_fpd_special_review_ajax", results = { @Result(name = "success", type = "json", params = {
	 ...
	 * @throws Exception
	 */
	@Action(value = "list_channel_rebate_review_fpd_special_review_ajax", results = { @Result(name = "success", type = "json", params = {
			"contentType", "text/json" }) })
