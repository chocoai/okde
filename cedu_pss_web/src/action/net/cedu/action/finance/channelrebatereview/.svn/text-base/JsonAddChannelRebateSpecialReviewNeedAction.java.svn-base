...
public class JsonAddChannelRebateSpecialReviewNeedAction extends BaseAction
{
	// 分页结果
	 ...
	 * @throws Exception
	 */
	@Action(value = "count_channel_rebate_review_fpd_special_for_now_review_ajax", results = { @Result(name = "success", type = "json", params = {
	 ...
	 * @throws Exception
	 */
	@Action(value = "list_channel_rebate_review_fpd_special_for_now_review_ajax", results = { @Result(name = "success", type = "json", params = {
			"contentType", "text/json" }) })
	 ...
	 * @throws Exception
	 */
	@Action(value = "sel_fpd_for_channel_rebate_special_review_ajax", results = { @Result(name = "success", type = "json", params = {
			"contentType", "text/json" }) })
	 ...
	 * @throws Exception
	 */
	@Action(value = "rem_fpd_for_channel_rebate_special_review_ajax", results = { @Result(name = "success", type = "json", params = {
			"contentType", "text/json" }) })
	 ...
	 * @throws Exception
	 */
	@Action(value = "count_checked_channel_rebate_review_fpd_special_review_ajax", results = { @Result(name = "success", type = "json", params = {
			"contentType", "text/json" }) })
				...
				if(fpd!=null)
				{
					...
					if(student!=null)
					{
						...
						{				
							...
							stu.getParamsString().put("channelIds", student.getParamsString().get("channelIds"));
							stu.setBranchId(-1);
							stu.setAcademyId(-1);
						...
						isbool=cpdsolBiz.updateStuFpdChannelRebateSpecialReviewByNewFpdIdOldFpdIdsStudentChannelId(Integer.valueOf(fIds[i]),feepdIds,stu,channelId,policeStatus);
						//更新不成功的缴费单
						if(!isbool)
						{
							//学生姓名
							...
							stu.setChannelId(channelId);//将合作方设置为主合作方id去匹配政策
