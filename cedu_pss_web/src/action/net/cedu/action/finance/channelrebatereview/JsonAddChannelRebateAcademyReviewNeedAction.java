...
public class JsonAddChannelRebateAcademyReviewNeedAction extends BaseAction
{
	// 分页结果
	 ...
	 * @throws Exception
	 */
	@Action(value = "count_channel_rebate_review_fpd_academy_for_now_review_ajax", results = { @Result(name = "success", type = "json", params = {
	 ...
	 * @throws Exception
	 */
	@Action(value = "list_channel_rebate_review_fpd_academy_for_now_review_ajax", results = { @Result(name = "success", type = "json", params = {
			"contentType", "text/json" }) })
	 ...
	 * @throws Exception
	 */
	@Action(value = "sel_fpd_for_channel_rebate_academy_review_ajax", results = { @Result(name = "success", type = "json", params = {
			"contentType", "text/json" }) })
	 ...
	 * @throws Exception
	 */
	@Action(value = "rem_fpd_for_channel_rebate_academy_review_ajax", results = { @Result(name = "success", type = "json", params = {
			"contentType", "text/json" }) })
	 ...
	 * @throws Exception
	 */
	@Action(value = "count_checked_channel_rebate_review_fpd_academy_review_ajax", results = { @Result(name = "success", type = "json", params = {
			"contentType", "text/json" }) })
		...
		if(feepdIds!=null && !feepdIds.equals(""))
		{
			...
			for(int i=0;i<fIds.length;i++)
			{
				...
				if(fpd!=null)
				{
					...
					if(student!=null)
					{
						isbool=cpdsolBiz.updateStuFpdChannelRebateReviewByNewFpdIdOldFpdIdsChannelRebateTimeId(Integer.valueOf(fIds[i]),feepdIds,channelRebateTimeId);
						//更新不成功的缴费单
						if(!isbool)
						{
							//学生姓名
