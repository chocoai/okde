...
public class JsonAddChannelRebateAcademyAction extends BaseAction
{
	 ...
	 * @throws Exception
	 */
	@Action(value = "add_channel_rebate_academy_ajax", results = { @Result(name = "success", type = "json", params = {
