...
public class JsonAddChannelRebateSpecialNeedAction extends BaseAction
{
	// 分页结果
	 ...
	 * @throws Exception
	 */
	@Action(value = "count_channel_rebate_fpd_special_for_now_review_ajax", results = { @Result(name = "success", type = "json", params = {
	 ...
	 * @throws Exception
	 */
	@Action(value = "list_channel_rebate_fpd_special_for_now_review_ajax", results = { @Result(name = "success", type = "json", params = {
			"contentType", "text/json" }) })
	 ...
	 * @throws Exception
	 */
	@Action(value = "test_fpd_for_channel_rebate_special_review_ajax", results = { @Result(name = "success", type = "json", params = {
			"contentType", "text/json" }) })
	...
	{	
				...
				if(fpd!=null && fpd.getFeeSubjectId()>0)
				{
					...
					if(student!=null)
					{
						...
						else
						{
							...
							cpds=this.cpdsBiz.findCpdsByStudentFeeSubjectIdForChannelRebateSpecialReview(student, fpd.getFeeSubjectId(),policeStatus);
							cpd=this.cpdsBiz.findCpdByStuFsIdForChannelRebateSpecialReview(student, fpd.getFeeSubjectId(),policeStatus);
						}
						if(cpds==null)
						{
							//缴费单的编号
		...
		if(addnewfpdIds!=null && !addnewfpdIds.equals(""))
		{
			this.cpdsBiz.updateStuFpdChannelRebateSpecialByNewFpdIdsOldFpdIdsReview(addnewfpdIds,newFeepdIds,policeStatus,channelId,minorChannelIds);
		}
		return SUCCESS;
	}
	 ...
	 * @throws Exception
	 */
	@Action(value = "del_fpd_for_channel_rebate_special_review_ajax", results = { @Result(name = "success", type = "json", params = {
			"contentType", "text/json" }) })
	public String delfpdforacademyrebate() throws Exception 
	{
		if(allFeepdIds!=null && !allFeepdIds.equals("") && delFeepdIds!=null && !delFeepdIds.equals(""))
		{
			...
			this.cpdsBiz.updateStuFpdChannelRebateSpecialByDelFpdIdsOldFpdIdsReview(delFeepdIds, newdelFeepdIds);
		}
		else
		{
			isfail=false;
	 ...
	 * @throws Exception
	 */
	@Action(value = "count_channel_rebate_fpd_special_for_now_all_money_ajax", results = { @Result(name = "success", type = "json", params = {
			"contentType", "text/json" }) })
