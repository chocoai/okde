...
public class JsonAddChannelRebateCommonAction extends BaseAction
{
	 ...
	 * @throws Exception
	 */
	@Action(value = "add_channel_rebate_common_ajax", results = { @Result(name = "success", type = "json", params = {
