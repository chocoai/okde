...
public class JsonPaymentMainAction extends BaseAction
{
	 ...
	 * @throws Exception
	 */
	@Action(value = "count_student_payment_main_ajax", results = { @Result(name = "success", type = "json", params = {
	 ...
	 * @throws Exception
	 */
	@Action(value = "list_student_payment_main_ajax", results = { @Result(name = "success", type = "json", params = {
			"contentType", "text/json" }) })
