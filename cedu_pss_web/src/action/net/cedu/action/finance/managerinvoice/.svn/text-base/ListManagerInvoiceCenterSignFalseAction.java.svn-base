...
public class ListManagerInvoiceCenterSignFalseAction extends BaseAction {
	...
	@Action(results = { @Result(name = "input", location = "list_manager_invoice_center_sign_false.jsp")
	})
