 ...
 * 
 */
public class ListManagerInvoiceCenterSignTrueAction extends BaseAction {
	...
	@Action(results = { @Result(name = "input", location = "list_manager_invoice_center_sign_true.jsp")
	})
