...
public class JsonExamRoomShenpiAction extends BaseAction  implements ModelDriven<ExamRoom>{
	/**
	 * 
	 */
	private static final long serialVersionUID = 4454736273022627599L;
