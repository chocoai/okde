...
public class EditChnlPlcyDtlAction extends BaseAction
{
	...
	private List<ChannelPolicy> policyList;
	...
	public String execute() throws Exception
	{
		...
		policyList = channelPolicyBiz.findAvaliableToChannel(detail.getChannelId(), detail.getAcademyId(), detail.getFeeSubjectId(),super.getUser().getOrgId());
	...
	public List<ChannelPolicy> getPolicyList() {
		return policyList;
	}
}
