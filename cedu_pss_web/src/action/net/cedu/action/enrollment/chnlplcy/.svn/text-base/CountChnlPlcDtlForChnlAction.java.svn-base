...
public class CountChnlPlcDtlForChnlAction extends BaseAction
{
	...
	{
		int count = channelPolicyDetailBiz.countForChannel(channelId, branchId, academyId, batchId, levelId, majorId, feeSubjectId, auditStatus, result);
