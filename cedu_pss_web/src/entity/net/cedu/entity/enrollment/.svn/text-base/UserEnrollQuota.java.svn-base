 ...
 */
@Entity
@Table(name="tb_e_user_enroll_quota")
public class UserEnrollQuota implements Serializable
{
	...
	@Column(name="user_id")
	private int userId;    // 中心人员Id
	
	@Column(name="target")
	private int target; // 指标
	
	@Column(name="expect_target")
	private int expectTarget; // 期望指标
	...
	@Transient
	transient private String userName;     //员工姓名
