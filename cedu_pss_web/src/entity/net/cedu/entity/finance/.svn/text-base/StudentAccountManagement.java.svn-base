 ...
 */
@Entity
@Table(name = "tb_e_student_account_management")
public class StudentAccountManagement  implements Serializable{
	...
	@Column(name = "using_status")  //状态
	private int usingStatus;
	

	@Column(name = "account_balance")
	private BigDecimal accountBalance;  //总缴费金额
	...
	@Transient
	transient private String batchName;   //招生批次
