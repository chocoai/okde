...
**************************/
        var strHtml1="<br><font color='#FF00FF'>打印控件未安装!点击这里<a href='"+WEB_ATTACHMENT+"/upload/cedu_print/install_lodop.exe'>执行安装</a>,安装后请刷新页面或重新进入。</font>";
        var strHtml2="<br><font color='#FF00FF'>打印控件需要升级!点击这里<a href='"+WEB_ATTACHMENT+"/upload/cedu_print/install_lodop.exe'>执行升级</a>,升级后请重新进入。</font>";
