...
//	setTimeout("zebraCrossing()",100);
	//var toggle = document.getElementById('stiwch_a');
//	jQuery("#stiwch_a").click(function() {
//		alert($(top.document.getElementById).html());
//		if (top.document.getElementById&&parent.document.getElementById) {
//			if (this.className == 'turnOff') {
//				top.document.getElementById('mainCont').cols = "0,10,*";
//				parent.document.getElementById('rootf').rows="0,*,28";
...
//				parent.document.getElementById('rootf').rows="87,*,28";
