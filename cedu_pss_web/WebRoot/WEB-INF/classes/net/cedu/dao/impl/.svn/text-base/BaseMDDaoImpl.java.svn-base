...
import net.cedu.common.reflection.ReflectionUtil;
...
public class BaseMDDaoImpl<T> implements BaseDao<T> {
	 ...
	 * 查询集合
	 * 
	 * @see net.cedu.dao.BaseDao#getByProperty(java.lang.String,
	 * java.lang.Object[])
	 */
	 ...
	 * 查询集合
	 * 
	 * @see net.cedu.dao.BaseDao#getByProperty(java.lang.String, java.util.List)
	 */
	...
	// * 逻辑删除
	// *
	// * @see net.cedu.dao.BaseDao#deleteByFlag(int)
	// */
	// public int deleteByFlag(int id) {
	// String hql = "update " + entityClass.getSimpleName() + " set "
	// + " deleteFlag=" + Constants.DELETE_TRUE + " where id=" + id;
	// if (Config.getBoolProperty("use.cache")) {
	// // 删除缓存
	// cacheClient.deleteObject(CacheTool.getCachedKey(entityClass, id));
	// }
	 ...
	 * 已删除
	 * 
	 * @see net.cedu.dao.BaseDao#findAllDeleted()
	 */
	 ...
	 * 未删除
	 * 
	 * @see net.cedu.dao.BaseDao#findAllNotDeleted()
	 */
	 ...
	 * 查询数量
	 * 
	 * @see net.cedu.dao.BaseDao#findCountByProperty(java.lang.String,
	 * java.lang.Object[])
	 */
	 ...
	 * 根据属性删除实体
	 * 
	 * @see net.cedu.dao.BaseDao#deleteByProperty(java.lang.String,
	 * java.lang.Object[])
	 */
	 ...
	 * 执行批量更新
	 * 
	 * @see net.cedu.dao.BaseDao#update(java.lang.String, java.lang.String,
	 * java.lang.Object[])
	 */
	 ...
	 * 可配置的删除
	 * 
	 * @see net.cedu.dao.BaseDao#deleteConfig(java.io.Serializable)
	 */
	 ...
	 * 可配置的删除（方法重载）
	 * 
	 * @see net.cedu.dao.BaseDao#deleteConfig(java.lang.Object)
	 */
	 ...
	 * 查询单个实体
	 * 
	 * @see net.cedu.dao.BaseDao#getObjByProperty(java.lang.String,
	 * java.lang.Object)
	 */
	 ...
	 * 执行Sql语句的模板
	 * 
	 * @see net.cedu.dao.BaseDao#getJdbcTemplate()
	 */
	 ...
	 * 执行Sql语句的模板
	 * 
	 * @see net.cedu.dao.BaseDao#getJdbcTemplatePlus()
	 */
	 ...
	 * 通过条件查询ID集合
	 * 
	 * @see net.cedu.dao.BaseDao#getIDs(java.lang.String, java.lang.Object[])
	 */
