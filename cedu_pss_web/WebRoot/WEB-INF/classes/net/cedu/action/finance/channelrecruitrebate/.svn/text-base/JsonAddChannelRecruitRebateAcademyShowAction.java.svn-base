...
/**
 * 招生返款申请（中心）显示可以返款的缴费单明细  2012-05-21 重构
 * 
 * @author xiao
 *
 */
@ParentPackage("json-default")
public class JsonAddChannelRecruitRebateAcademyShowAction extends BaseAction
{
	 ...
	 * @throws Exception
	 */
	@Action(value = "count_channel_recruit_rebate_fpd_academy_review_ajax", results = { @Result(name = "success", type = "json", params = {
	...
	{		
		...
		//是否开课
		student.getParamsInt().put("isStartCourse", Constants.STU_IS_START_COURSE_TRUE);
		//是否已招生途径复核
		student.getParamsInt().put("isChannelTypeChecked", Constants.STUDENT_CHANNEL_TYPE_CHECKED_TRUE);
	 ...
	 * @throws Exception
	 */
	@Action(value = "list_channel_recruit_rebate_fpd_academy_review_ajax", results = { @Result(name = "success", type = "json", params = {
			"contentType", "text/json" }) })
