...
public class JsonViewPayAcademyCeduReviewAction extends BaseAction
{
	// 分页结果
	 ...
	 * @throws Exception
	 */
	@Action(value = "view_academy_rebate_review_count_ajax", results = { @Result(name = "success", type = "json", params = {
	 ...
	 * @throws Exception
	 */
	@Action(value = "view_academy_rebate_review_list_ajax", results = { @Result(name = "success", type = "json", params = {
			"contentType", "text/json" }) })
	 ...
	 * @throws Exception
	 */
	@Action(value = "view_academy_year_rebate_count_ajax", results = { @Result(name = "success", type = "json", params = {
			"contentType", "text/json" }) })
	public String playyearmoneyCount() throws Exception 
	{
		FeePaymentDetail feePaymentDetail=new FeePaymentDetail();
		feePaymentDetail.setAcademyYearRebateId(payAcademyCeduId);	
		result.setRecordCount(this.feePaymentDetailBiz.findFeePaymentDetailCountByPageForViewAcademyRebate(feePaymentDetail, result));
		return SUCCESS;
	}
	 ...
	 * @throws Exception
	 */
	@Action(value = "view_academy_year_rebate_list_ajax", results = { @Result(name = "success", type = "json", params = {
			"contentType", "text/json" }) })
	public String playyearmoneyList() throws Exception 
	{	
		FeePaymentDetail feePaymentDetail=new FeePaymentDetail();
		feePaymentDetail.setAcademyYearRebateId(payAcademyCeduId);
		result.setList(this.feePaymentDetailBiz.findFeePaymentDetailListByPageForViewAcademyRebate(feePaymentDetail,result));
