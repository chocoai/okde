...
/**
 * 招生返款申请（中心）显示可以返款的缴费单明细  2012-04-04 重构
 * 
 * @author xiao
 *
 */
@ParentPackage("json-default")
public class JsonAddChannelRebateAcademyShowAction extends BaseAction
{
	...
	/**
	 * 获取适合招生返款的缴费单明细数量_重构_2012-04-05
	 * @return
	 * @throws Exception
	 */
	@Action(value = "count_channel_rebate_fpd_academy_review_ajax", results = { @Result(name = "success", type = "json", params = {
	...
	public String channelRebateReviewCount() throws Exception 
	{
		...
		result.setRecordCount(this.feePaymentDetailBiz.findfpdCountByPageForChannelRebateAcademyReview(feePaymentDetail, student,feepdIds, starttime,endtime));
		return SUCCESS;
	}

	/**
	 * 获取适合招生返款的缴费单明细列表_重构_2012-04-05
	 * @return
	 * @throws Exception
	 */
	@Action(value = "list_channel_rebate_fpd_academy_review_ajax", results = { @Result(name = "success", type = "json", params = {
			"contentType", "text/json" }) })
	...
	{	
		...
		result.setList(this.feePaymentDetailBiz.findfpdListByPageForChannelRebateAcademyReview(feePaymentDetail, student,feepdIds, starttime, endtime, result));
		return SUCCESS;
	}
