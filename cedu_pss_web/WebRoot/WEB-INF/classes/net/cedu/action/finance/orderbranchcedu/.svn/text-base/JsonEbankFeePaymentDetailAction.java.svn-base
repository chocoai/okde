...
public class JsonEbankFeePaymentDetailAction extends BaseAction
{
	// 分页结果
	 ...
	 * @throws Exception
	 */
	@Action(value = "count_ebank_feepaymentdetail_page_ajax", results = { @Result(name = "success", type = "json", params = {
			"contentType", "text/json" ,
			"includeProperties",
			"result.*,feePaymentDetail,code,student, startDate, endDate"
	}) })
	public String playmoneyCount() throws Exception 
	{
		...
		feePayment.setFeeWayId(Constants.PAYMENT_METHOD_WANG_YIN_ZONG_BU);
	 ...
	 * @throws Exception
	 */
	@Action(value = "list_ebank_feepaymentdetail_page_ajax", results = { @Result(name = "success", type = "json", params = {
			"contentType", "text/json" }) })
	 ...
	 * @throws Exception
	 */
	@Action(value = "count_ebank_cedu_fpd_all_money_ajax", results = { @Result(name = "success", type = "json", params = {
			"contentType", "text/json" }) })
	public String countebankcedu() throws Exception 
	{	
		feePaymentDetail.setStartStatusId(Constants.PAYMENT_STATUS_YI_HUI_KUAN_ZONG_BU);
		feePaymentDetail.setEndStatusId(Constants.PAYMENT_STATUS_YI_HUI_KUAN_QU_DAO);
		FeePayment feePayment=new FeePayment();
