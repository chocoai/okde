...
public class ExcelExportStudentEnrollmentSourceAction extends BaseAction {
	...
	public String execute() throws Exception {
		...
		if (reportList != null && reportList.size() != 0) {
			downLoadFile(createExcel(reportList, "学生招生途径统计表",map), "学生招生途径统计表"+ ".xls");
				...
				for (int j = 0; j < xuexizhongxinList.size(); j++) {
					...
					for (int k = 0; k < fuwuzhanList.size(); k++) {
						...
						for (int l = 0; l < userList.size(); l++) {
							...
							createCell(wb, bodyRow, 5, userObject.get("shezhaoCount").toString(),HSSFColor.WHITE.index);
							createCell(wb, bodyRow, 6, userObject.get("shezhaoCountP").toString(),HSSFColor.WHITE.index);
							createCell(wb, bodyRow, 7, userObject.get("qudaoCount").toString(),HSSFColor.WHITE.index);
							createCell(wb, bodyRow, 8, userObject.get("qudaoCountP").toString(),HSSFColor.WHITE.index);
							createCell(wb, bodyRow, 9, userObject.get("dakehuCount").toString(),HSSFColor.WHITE.index);
							createCell(wb, bodyRow, 10, userObject.get("dakehuCountP").toString(),HSSFColor.WHITE.index);
							createCell(wb, bodyRow, 11, userObject.get("laodaixinCount").toString(),HSSFColor.WHITE.index);
							createCell(wb, bodyRow, 12, userObject.get("laodaixinCountP").toString(),HSSFColor.WHITE.index);
							createCell(wb, bodyRow, 13, userObject.get("laoshengxuduCount").toString(),HSSFColor.WHITE.index);
							createCell(wb, bodyRow, 14, userObject.get("laoshengxuduCountP").toString(),HSSFColor.WHITE.index);
							createCell(wb, bodyRow, 15, userObject.get("jiamengCount").toString(),HSSFColor.WHITE.index);
							createCell(wb, bodyRow, 16, userObject.get("jiamengCountP").toString(),HSSFColor.WHITE.index);
							createCell(wb, bodyRow, 17, userObject.get("gongjianCount").toString(),HSSFColor.WHITE.index);
							createCell(wb, bodyRow, 18, userObject.get("gongjianCountP").toString(),HSSFColor.WHITE.index);
							createCell(wb, bodyRow, 19, userObject.get("hejiCount").toString(),HSSFColor.YELLOW.index);
							createCell(wb, bodyRow, 20, userObject.get("hejiCountP").toString(),HSSFColor.YELLOW.index);
						...
						createCell(wb, bodyRow, 5, fuwuzhanHeJiMap.get("shezhaoCountSum").toString(),HSSFColor.GREY_25_PERCENT.index);
						createCell(wb, bodyRow, 6, fuwuzhanHeJiMap.get("shezhaoCountPSum").toString(),HSSFColor.GREY_25_PERCENT.index);
						createCell(wb, bodyRow, 7, fuwuzhanHeJiMap.get("qudaoCountSum").toString(),HSSFColor.GREY_25_PERCENT.index);
						createCell(wb, bodyRow, 8, fuwuzhanHeJiMap.get("qudaoCountPSum").toString(),HSSFColor.GREY_25_PERCENT.index);
						createCell(wb, bodyRow, 9, fuwuzhanHeJiMap.get("dakehuCountSum").toString(),HSSFColor.GREY_25_PERCENT.index);
						createCell(wb, bodyRow, 10, fuwuzhanHeJiMap.get("dakehuCountPSum").toString(),HSSFColor.GREY_25_PERCENT.index);
						createCell(wb, bodyRow, 11, fuwuzhanHeJiMap.get("laodaixinCountSum").toString(),HSSFColor.GREY_25_PERCENT.index);
						createCell(wb, bodyRow, 12, fuwuzhanHeJiMap.get("laodaixinCountPSum").toString(),HSSFColor.GREY_25_PERCENT.index);
						createCell(wb, bodyRow, 13, fuwuzhanHeJiMap.get("laoshengxuduCountSum").toString(),HSSFColor.GREY_25_PERCENT.index);
						createCell(wb, bodyRow, 14, fuwuzhanHeJiMap.get("laoshengxuduCountPSum").toString(),HSSFColor.GREY_25_PERCENT.index);
						createCell(wb, bodyRow, 15, fuwuzhanHeJiMap.get("jiamengCountSum").toString(),HSSFColor.GREY_25_PERCENT.index);
						createCell(wb, bodyRow, 16, fuwuzhanHeJiMap.get("jiamengCountPSum").toString(),HSSFColor.GREY_25_PERCENT.index);
						createCell(wb, bodyRow, 17, fuwuzhanHeJiMap.get("gongjianCountSum").toString(),HSSFColor.GREY_25_PERCENT.index);
						createCell(wb, bodyRow, 18, fuwuzhanHeJiMap.get("gongjianCountPSum").toString(),HSSFColor.GREY_25_PERCENT.index);
						createCell(wb, bodyRow, 19, fuwuzhanHeJiMap.get("hejiCountSum").toString(),HSSFColor.GREY_25_PERCENT.index);
						createCell(wb, bodyRow, 20, fuwuzhanHeJiMap.get("hejiCountPSum").toString(),HSSFColor.GREY_25_PERCENT.index);
