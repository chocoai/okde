...
public class ListChnlPlcDtlForChnlAction extends BaseAction
{
	...
	{
		List<ChannelPolicyDetail> list = channelPolicyDetailBiz.findForChannel(channelId, branchId, academyId, batchId, levelId, majorId, feeSubjectId, auditStatus, result);
