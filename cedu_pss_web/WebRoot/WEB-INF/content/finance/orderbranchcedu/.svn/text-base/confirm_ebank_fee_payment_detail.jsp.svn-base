...
<head>
	...
	<a:ajax 
		...
		pluginCode="1110" 
		urls="finance/orderbranchcedu/count_ebank_cedu_fpd_all_money_ajax"
	/>
	<!-- 批量确认 -->
	<a:ajax 
...
<body>
	...
	<%@include file="_cedu_confirm_tab.jsp" %>
		<table class="gv_table_2">
			<tr>
				...
				<th style="text-align:left; font-weight:bold;">网银总部 &gt;&gt; 总部确认</th>
				<th></th>
			</tr>
		</table>
	...
	<form id="searchParam">
		...
		<page:plugin 
			...
			subStringLength="50"
			searchListActionpath="/finance/orderbranchcedu/list_ebank_feepaymentdetail_page_ajax"
			searchCountActionpath="/finance/orderbranchcedu/count_ebank_feepaymentdetail_page_ajax"
