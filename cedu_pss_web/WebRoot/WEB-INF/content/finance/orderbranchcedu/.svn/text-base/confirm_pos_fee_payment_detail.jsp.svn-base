...
<head>
	...
	<script type="text/javascript">
		...
		function download()
		{
			if($("#branchId").val()=="0" && $("#academyId").val()=="0")
			{
				alert("学习中心或院校必选一！");
				return false;
			}
	...
	<a:ajax 
		...
		pluginCode="1110" 
		urls="finance/orderbranchcedu/count_pos_cedu_fpd_all_money_ajax"
	/>
	<!-- 批量确认 -->
	<a:ajax 
	...
	<a:ajax 
		...
		urls="finance/orderbranchcedu/excel_export_pos_fee_payment_detail_search_ajax"
	/>
	...
	<%@include file="_cedu_confirm_tab.jsp" %>
		<table class="gv_table_2">
			<tr>
				...
				<th style="text-align:left; font-weight:bold;">POS直汇总部 &gt;&gt; 总部确认</th>
				<th></th>
			</tr>
		</table>
	...
	<form id="searchParam">
		<table class="add_table">
			<tr>			
				...
				<td><s:select list="branches" listKey="id" listValue="name" headerKey="0" headerValue="--请选择--" name="student.branchId" id="branchId" cssClass="txt_box_150"></s:select></td>
			...
			<tr>	
				...
				<td>
					...
					<input type="button" class="btn_black_61" value="导出" onclick="download()"/>
				</td>
			</tr>
		</table>
	</form>
		...
		<page:plugin 
			...
			subStringLength="50"
			searchListActionpath="/finance/orderbranchcedu/list_pos_feepaymentdetail_page_ajax"
			searchCountActionpath="/finance/orderbranchcedu/count_pos_feepaymentdetail_page_ajax"
