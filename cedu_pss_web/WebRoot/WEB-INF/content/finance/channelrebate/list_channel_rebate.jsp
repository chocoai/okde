...
<body>
	<head:head title="返款申请(中心)">
		<html:a text="单院校计算返款" icon="add" href="/finance/channelrebate/add_channel_rebate_academy" target="_blank"/>
		<html:a text="多院校合并计算返款" icon="add" href="/finance/channelrebate/add_channel_rebate_common" target="_blank"/>
		<html:a text="跨中心合并计算返款" icon="add" href="/finance/channelrebate/add_channel_rebate_special" target="_blank"/>
	</head:head>
	<body:body>
