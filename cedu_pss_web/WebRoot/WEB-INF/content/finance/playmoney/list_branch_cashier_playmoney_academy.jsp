	...
	<head>
		...
		<script type="text/javascript">
			...
			function comoperated(id,status,types)
			{
				...
				{
					return '<a href="javascript:ceduconfirm('+id+');">中心确认</a>&nbsp;&nbsp;<a href="javascript:fallBack('+id+')">回退</a>';
				}
		...
		<body:body>
				...
				<table class="gv_table_2">
			  		<tr>
					 	...
					 	<th style="text-align:left; font-weight:bold;" class="feehtml">汇款院校确认</th>
	              	...
	              	<tr>
		                ...
		                <td align="left">
		                	<select id="status" name="payCeduAcademy.status" class="txt_box_150">
								...
								<option value="<%=Constants.PAYMENT_STATUS_YI_QUE_REN_DAI_HUI_KUAN %>">已汇款待确认</option>
