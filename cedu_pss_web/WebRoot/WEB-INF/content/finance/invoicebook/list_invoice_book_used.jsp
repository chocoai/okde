...
<html>
  <head>
    ...
    <title>所有收据</title>
		...
		<a:ajax parameters="{'id':ids,'isCancel':Fee_STATUS_TRUE}"
				successCallbackFunctions="ajax_update"
				urls="/finance/invoicebook/updatereceiptiscancel"
		 pluginCode="123" />
		...
		*/
		...
		{
			//return '<a href="'+WEB_PATH+'/crm/view_student_details?id='+studentId+'">'+name+'</a>';
			return name;
		}
		...
		*/
		...
		声明作废
		*/
		function updatestatus(id,isCanceled)
		{
			if(isCanceled==Fee_STATUS_FALSE)
			{
  ...
  <body>
		...
		<input type="hidden" id="branchlst" name="branchlst" ></input>
			...
			<page:plugin 
					...
					customColumnValue="0,linkcode(feePaymentId,code);1,linkstudent(studentId,studentName);6,getstatus();7,iscanceled(isCanceled);8,updatestatus(id,isCanceled)"
					pageSize="10"
