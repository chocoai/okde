			                ...
			                <td align="left">
								<input type="button" class="btn_black_61"  onclick="showsearch();" value="查询"/>
									...
									<page:plugin 
										...
										columnsStr="createdTime;studentName;schoolName;academyenrollbatchName;levelName;majorName;feeSubjectName;accountMoney"
										customColumnValue="0,showtime(createdTime);7,feePaymentValue(accountMoney)"
										pageSize="10"
										isPackage="false"
