		...
		<table class="add_table">
			<tbody id="rebateCondition">
				...
				<tr>
					...
					<td><span id="paysum"><s:property value="payAcademyCedu.currentYear"/></span></td>
				</tr>
				<tr>
	  	 ...
	  	 <table class="gv_table_2">
		 	<tr>
				<th style="width:20px;"><img src="<ui:img url="/images/title_menu/title_left.gif"/>" /></th>
				<th style="text-align:left; font-weight:bold;">年度追加返款缴费单明细</th>
				<th></th>
			</tr>
		</table>
			<page:plugin 
				...
				subStringLength="20"
				searchListActionpath="view_academy_year_rebate_list_ajax"
				searchCountActionpath="view_academy_year_rebate_count_ajax"
				columnsStr="paymentCode;schoolName;branchName;academyenrollbatchName;levelName;majorName;studentName;paymentSubjectName;jiaofeiValue;moneyToCedu;academyYearRebateAddMoney;#status"
