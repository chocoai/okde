...
<head>
	...
	<a:ajax 
		...
		pluginCode="confirm" 
		urls="/finance/payacademycedu/confirm_academy_year_rebate_review_ajax"
	/>
	...
	<a:ajax 
		...
		urls="/finance/academyrebatereview/del_academy_year_rebate_review_ajax" 
		pluginCode="110"
	/>
...
<body>
	<head:head title="院校年度返款单">
		<html:a text="添加院校年度返款单" icon="add" href="/finance/academyrebatereview/add_academy_year_rebate_review" target="_blank"/>
	</head:head>
	<body:body>
	...
	<form id="searchForm">
		...
		<page:plugin 
			...
			columnsStr="#remitteracademy;currentYear;adjustPaied;addPaied;#amountpaied;note;#remittancedate;#status;#types"
			customColumnValue="0,showtitle(remitterName);2,feePaymentValue(adjustPaied);3,feePaymentValue(addPaied);4,feePaymentValue(amountPaied);6,showtitle(remittanceDate);7,toStatus(status,types,id);8,showtypes(types)"
			pageSize="20"			
			view="http,/finance/academyrebatereview/view_academy_year_rebate_review,payAcademyCeduId,id,_blank"
