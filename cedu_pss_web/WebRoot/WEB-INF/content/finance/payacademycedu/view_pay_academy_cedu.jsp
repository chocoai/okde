		...
		<table class="add_table">
	  	 ...
	  	 <table class="gv_table_2">
			...
			<page:plugin 
				...
				subStringLength="20"
				searchListActionpath="view_academy_rebate_list_ajax"
				searchCountActionpath="view_academy_rebate_count_ajax"
		...
		<table class="add_table">
			<tbody>
				<tr>
					...
					<td><span id="paysum"><s:property value="payAcademyCedu.amount"/></span></td>
				</tr>
				<tr>
