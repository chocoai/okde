...
<body>
	...
	<body:body>
		<table class="gv_table_2">
			<tr>
				...
				<th style="text-align:left; font-weight:bold;">院校返款 &gt;&gt; 返款单查询</th>
				<th></th>
			</tr>
		</table>
	...
	<form id="searchForm">
		...
		<page:plugin 
			...
			columnsStr="#remitteracademy;#amount;adjustPaied;addPaied;#amountpaied;note;#remittancedate;#status;#types;#operation"
			customColumnValue="0,showtitle(remitterName);1,feePaymentValue(amount);2,feePaymentValue(adjustPaied);3,feePaymentValue(addPaied);4,feePaymentValue(amountPaied);6,showtitle(remittanceDate);7,toStatus(status);8,showtypes(types);9,toOperation(id,status,types)"
			pageSize="20"
