...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			{
				if(newstuId == 0)
					return "<a href='javascript:stucontinue("+id+");'>续读</a>";
				return "";
			}
			//读取学生信息
		...
		<a:ajax 
			...
			urls="finance/studentsenrolled/upate_student_continue_ajax"
		/>
		<!-- 读取学生信息  -->
		<a:ajax 
			pluginCode="001"
			...
			urls="finance/studentsenrolled/view_student_continue_ajax"
		/>
							...
							<tr>
								...
								<td align="left">
									...
									<page:plugin 
										pluginCode="001"
										il8nName="crm"
										searchListActionpath="list_student_continue_page_ajax"
										searchCountActionpath="count_student_continue_page_ajax"
										columnsStr="name;certNo;status;gender;schoolName;academyenrollbatchName;levelName;majorName;#operation"
										customColumnValue="2,statusValue(status);3,sexValue(gender);8,showxudu(id,newstuId)"
										pageSize="10"
