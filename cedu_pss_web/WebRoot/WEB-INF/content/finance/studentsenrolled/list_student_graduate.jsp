...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function showbiye(id,status)
			{
				if(status<STU_CALL_STATUS_YI_BI_YI)
				{
					return "<a href='javascript:stugraduate("+id+");'>毕业</a>";
				}
				return "";
			}
			//录取
			function stugraduate(id)
			{
			...
			var startId=STU_CALL_STATUS_YI_FU_HE;
		...
		<a:ajax 
			...
			urls="finance/studentsenrolled/upate_student_graduate_ajax"
		/>
	</head>
	<body>
		<!--头部层开始 -->
		<head:head title="学生毕业">
		</head:head>
		<!--主体层开始 -->
		<body:body>
				<form id="search_form">
							...
							<tr>
								...
								<td align="left">
									...
									<page:plugin 
										pluginCode="001"
										il8nName="crm"
										searchListActionpath="list_student_graduate_page_ajax"
										searchCountActionpath="count_student_graduate_page_ajax"
										...
										customColumnValue="8,statusValue(status);9,showbiye(id,status)"
										pageSize="10"
