...
<head>
	...
	<script type="text/javascript">
		...
		function operate(id,status,types)
		{
			...
			{
				return '<a href="javascript:updateOcc('+id+');">汇款</a>&nbsp;&nbsp;<a href="javascript:fallBack('+id+')">回退</a>';
			}
			return "";
		}
	...
	<a:ajax 
		...
		urls="/finance/branchchannelpayment/update_hr_pay_branch_channel_ajax" 
		pluginCode="110"
	/>
	<!--更新招生返款单回退状态-->
	<a:ajax 
				...
				<tr>
					...
					<td align="left">
						<select id="status" name="orderCeduChannel.status" class="txt_box_150">
							...
							<option selected="selected" value="<%=Constants.PAYMENT_STATUS_CAI_WU_YI_SHEN_HE %>">财务已审核</option>
