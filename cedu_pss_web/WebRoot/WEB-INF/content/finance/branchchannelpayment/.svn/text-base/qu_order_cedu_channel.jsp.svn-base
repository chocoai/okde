...
<head>
	...
	<script type="text/javascript">
		...
		function operate(id,status,types)
		{
			...
			{
				return '<a href="javascript:updateOcc('+id+');">渠道审核</a>&nbsp;&nbsp;<a href="javascript:fallBack('+id+')">回退</a>';
			}
			return "";
		}
				...
				<tr>
					...
					<td align="left">
						...
						<page:plugin 
							...
							customColumnValue="4,showmoney(amountPaied);7,parseStatus(id,status);8,showtypes(types);9,operate(id,status,types)"
