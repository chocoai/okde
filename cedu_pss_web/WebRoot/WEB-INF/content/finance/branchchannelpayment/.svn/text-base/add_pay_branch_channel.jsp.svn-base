...
<head>
	...
	<a:ajax 
		...
		urls="/finance/branchchannelpayment/test_feepaymentdetail_for_channel_rebate_ajax" 
		pluginCode="120"
	/>
	...
	<a:ajax 
		...
		urls="/finance/branchchannelpayment/del_feepaymentdetail_for_channel_rebate_ajax" 
		pluginCode="130"
	/>
	...
	<a:ajax 
		...
		urls="/finance/branchchannelpayment/add_pay_branch_channel_ajax" 
		pluginCode="140"
	/>
			...
			<table class="gv_table_2">
				<tr>
					...
					<page:plugin 
						...
						il8nName="finance_payment"
						subStringLength="20"
						searchListActionpath="list_channel_rebate_feepaymentdetail_for_now_ajax"
						searchCountActionpath="count_channel_rebate_feepaymentdetail_for_now_ajax"
