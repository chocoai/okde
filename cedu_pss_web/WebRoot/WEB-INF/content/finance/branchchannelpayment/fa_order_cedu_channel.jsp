...
<head>
	...
	<script type="text/javascript">
		...
		function operate(id,status,types)
		{
			...
			{
				return '<a href="javascript:updateOcc('+id+');">财务审核</a>&nbsp;&nbsp;<a href="javascript:fallBack('+id+')">回退</a>';
			}
			return "";
		}
		...
		<form id="myform" name="myform">
			<table class="gv_table_2">
		  		<tr>
				 	...
				 	<th style="text-align:left; font-weight:bold;">招生返款审核(财务)</th>
					<th></th>
				</tr>
			</table>
				...
				<tr>
					...
					<td align="left">
						<select id="status" name="orderCeduChannel.status" class="txt_box_150">
							...
							<option selected="selected" value="<%=Constants.PAYMENT_STATUS_SHANG_WU_YI_SHENG_HE %>">商务已审核</option>
