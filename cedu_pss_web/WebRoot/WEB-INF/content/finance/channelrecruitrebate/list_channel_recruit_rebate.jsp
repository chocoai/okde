...
<body>
	<head:head title="返款申请(中心)">
		<s:if test="#request.isback==false">
			<html:a text="单院校计算返款" icon="add" href="/finance/channelrecruitrebate/add_channel_recruit_rebate_academy" target="_blank"/>
			<html:a text="多院校合并计算返款" icon="add" href="/finance/channelrecruitrebate/add_channel_rebate_common" target="_blank"/>
			<html:a text="跨中心合并计算返款" icon="add" href="/finance/channelrecruitrebate/add_channel_rebate_special" target="_blank"/>
		</s:if>
		<s:else>
				...
				<tr>
					...
					<td align="left">
						...
						<page:plugin 
							...
							il8nName="finance"
							subStringLength="20"
							searchListActionpath="/cedu/finance/branchchannelpayment/list_pay_branch_channel_ajax"
							searchCountActionpath="/cedu/finance/branchchannelpayment/count_pay_branch_channel_ajax"
							columnsStr="branchName;channelTypeName;channelName;amountToPay;#amountpaied;adjustReason;payDate;#statusname;#types"
							customColumnValue="4,showmoney(amountPaied);7,parseStatus(id,status,types);8,showtypes(types)"
