		...
		<body:body>
				...
				<table class="gv_table_2">
			  		<tr>
					 	...
					 	<th style="text-align:left; font-weight:bold;" class="feehtml">院校汇款总部</th>
	             	...
	             	<tr >
	             		...
	             		<td>
	             			<select name="refundCeduAcademy.status" id="paymentStatus" class="txt_box_150">
								<option value="0">--请选择--</option>
								<option selected="selected" value="<%=Constants.REFUND_ADVANCE_STATUS_NOT_PAYMENT %>">院校未汇款</option>
								<option value="<%=Constants.REFUND_ADVANCE_STATUS_PAYMENT %>">院校已汇款</option>
