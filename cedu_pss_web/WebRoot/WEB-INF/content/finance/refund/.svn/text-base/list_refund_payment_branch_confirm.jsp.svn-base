	...
	<head>
		...
		<script type="text/javascript">
			...
			function approval()
			{
				...
				{
					jQuery("#showDialog").html('<b>请选择要批量确认汇款的退费单！</b>');
		...
		<body:body>
				...
				<table class="gv_table_2">
			  		<tr>
					 	...
					 	<th style="text-align:left; font-weight:bold;" class="feehtml">总部汇款学习中心</th>
						
					</tr>
				</table>
				<form id="myform" name="myform">
				<!-- 类型：总部 -->
				<input type="hidden" name="refundBranch.types" value="<%=Constants.REFUND_BRANCH_TYPES_CEDU %>" />
				<!-- 状态范围：全部 -->
