...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			{
				if(status==PAYMENT_STATUS_TUI_FEI_SHEN_PI_TONG_GUO)
				{
					return "<a href='"+WEB_PATH+"/finance/refund/confirm_refund_payment?feePaymentId="+id+"' target='_blank'>审批</a>";
				}
				return "";
			}
		...
		<body:body>
				<table class="gv_table_2">
			  		<tr>
					 	...
					 	<th style="text-align:left; font-weight:bold;" class="feehtml">退费审批(财务)</th>
		                ...
		                <td align="left">
	             		...
	             		<td>
	             			<select name="feePayment.status" id="paymentStatus" class="txt_box_150">
								...
								<option value="<%=Constants.PAYMENT_STATUS_TUI_FEI_SHEN_PI_TONG_GUO %>" selected="selected">已退费确认</option>
		                ...
		                <td align="left">
							...
							<input type="button" class="btn_black_61"  onclick="refresh001();" value="刷新"/>
									...
									<page:plugin 
										...
										columnsStr="createdTime;paymentcode;studentName;schoolName;academyenrollbatchName;levelName;majorName;feePayment;rechargeAmount;totalAmount;note;pamentType;status;#public.operating"
