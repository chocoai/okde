		...
		<body:body>
				...
				<table class="gv_table_2">
			  		<tr>
					 	...
					 	<th style="text-align:left; font-weight:bold;" class="feehtml">院校收款确认</th>
	             	...
	             	<tr >
	             		...
	             		<td>
	             			<select name="refundAcademyCedu.status" id="paymentStatus" class="txt_box_150">
								<option value="0">--请选择--</option>
								<option value="<%=Constants.REFUND_ADVANCE_STATUS_NOT_PAYMENT %>">总部未汇款</option>
								<option selected="selected" value="<%=Constants.REFUND_ADVANCE_STATUS_PAYMENT %>">总部已汇款</option>
