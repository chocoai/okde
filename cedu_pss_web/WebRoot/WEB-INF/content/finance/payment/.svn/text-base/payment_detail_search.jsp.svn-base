...
<head>
	...
	<a:ajax 
		...
		urls="finance/payment/excel_export_payment_detail_search_admin_ajax_"
	/>
	<!-- 下载地址2 -->
	<a:ajax 
		parameters="jQuery('#myform').serializeObject()" 
		...
		urls="finance/studentaccountmanagement/excel_export_stu_account_amount_management_ajax"
	/>
</head>
<body>
					...
					<form id="myform" method="post">
						<table class="gv_table_2">
							<tr>
								...
								<th style="text-align:left; font-weight:bold;">缴费单明细查询条件</th>
								<th></th>
							</tr>
						</table>
						<table class="add_table">
							<tbody id="rebateCondition">	
							   <tr>
								  ...
								  <td align="left">
								  	<select class="txt_box_150" name="student.branchId" id="branchId">
								...
								<tr>	
									...
									<td align="right">来源复核：</td>
									<td >
										<select name="student.paramsInt.isChannelTypeChecked" class="txt_box_150">
											<option value="-1">全部</option>
											<option value="<%=Constants.STUDENT_CHANNEL_TYPE_CHECKED_FALSE %>">未复核</option>
											<option value="<%=Constants.STUDENT_CHANNEL_TYPE_CHECKED_TRUE %>">已复核</option>
										</select>
									</td>
				             	</tr>
				             	<tr>				             		
