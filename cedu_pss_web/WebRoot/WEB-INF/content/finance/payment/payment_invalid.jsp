...
<html>
	<head>
		...
		<a:ajax parameters="jQuery('#myform1').serializeObject()" successCallbackFunctions="successCallbackFunction" pluginCode="0001" urls="finance/payment/update_payment_invalid_status"/>
		...
		<script type="text/javascript">
			...
			function operatingValue(id){
				return "<a href='#' onclick='paymentConfirm("+id+")'>作废</a>";
			}
	...
	<!-- 头开始 -->
		...
		<body:body>
				<form id="myform1" name="myform1">
					<input type="hidden" name="feePayment.status" value="<%=Constants.PAYMENT_STATUS_ZUO_FEI %>"/>
				...
				<table class="gv_table_2">
			  		<tr>
					 	...
					 	<th style="text-align:left; font-weight:bold;" class="feehtml">缴费单作废</th>
		                ...
		                <td align="left">
							<input type="button" class="btn_black_61"  onclick="search001();" value="查询"/>
									...
									<page:plugin 
										...
										columnsStr="createdTime;paymentcode;studentName;schoolName;academyenrollbatchName;levelName;majorName;feeWayId;feePayment;pamentType;status;#public.operating"
										customColumnValue="1,showcode(code,id);7,feeWayIdValue(feeWayId);8,feePaymentValue(feePayment);9,pamentTypeValue(pamentType);10,statusValue(status);11,operatingValue(id)"
										pageSize="10"
										isPackage="false"
