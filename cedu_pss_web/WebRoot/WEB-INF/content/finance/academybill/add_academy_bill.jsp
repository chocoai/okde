...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
	...
	<head:head title="新增应收学校款">
		<html:a text="返回" icon="return" href="/finance/academybill/list_academy_bill"/>
	</head:head>
	<body:body>
<form id="form" action="<uu:url url="/finance/academybill/add_academy_bill"/>" method="post" enctype="multipart/form-data">
	<table class="gv_table_2">
		<tr>
			<th style="width:20px;"><img src="<ui:img url="/images/title_menu/title_left.gif" />" /></th>
			<th style="text-align:left; font-weight:bold;">新增应收学校款</th>
		</tr>
	</table>
	...
	<table class="add_table">
		<tr>
			...
			<td><s:select id="academyId" name="academyId" list="academies" listKey="id" listValue="name" cssClass="txt_box_150"></s:select></td>
		...
		<tr>
			<td class="lable_100"><span>*</span>收款类型：</td>
			<td>
				<s:select id="receivedWay" name="receivedWay" list="billWays" listKey="id" listValue="name" cssClass="txt_box_150"></s:select>
			</td>
			<td><span id="receivedWayTip"></span></td>
		</tr>
		<tr>
			<td class="lable_100"><span>*</span>应收金额：</td>
			<td><input type="text" id="amount" name="amount" class="txt_box_150"/></td>
