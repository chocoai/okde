...
<head>
	...
	<script type="text/javascript">
		...
		var status=PAYMENT_STATUS_QU_DAO_YI_SHENG_HE;
		...
		<form id="myform" name="myform">
			<table class="gv_table_2">
		  		<tr>
				 	...
				 	<th style="text-align:left; font-weight:bold;">合作返款审核(渠道)</th>
					<th></th>
				</tr>
			</table>
			...
			<table class="add_table" style="text-align:center !important;">
				<tr>
					...
					<td align="left">
						<input type="hidden" name="areaManagerId" id="areaManagerId" value="${areaManagerId}"/>
				...
				<tr>	
					...
					<td align="left">
						<select id="status" name="orderCeduChannel.status" class="txt_box_150">
							<option value="0">--请选择--</option>
							<option selected="selected" value="<%=Constants.PAYMENT_STATUS_YI_TIAN_ZHAO_SHENG_FAN_KUAN %>">已填招生返款</option>
				...
				<tr>
					...
					<td align="left">
						...
						<page:plugin 
							...
							customColumnValue="3,showmoney(amountToPay);4,showmoney(adjustPaied);5,showmoney(amountPaied);8,parseStatus(id,status);9,showtypes(types);11,operate(id,status,types)"
							isChecked="true"
							checkboxValue="id"
