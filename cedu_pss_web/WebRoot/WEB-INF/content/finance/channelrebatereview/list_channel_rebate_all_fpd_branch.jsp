...
<head>
	...
	<a:ajax 
		...
		urls="/finance/channelrebatereview/excel_export_list_channel_rebate_all_fpd_branch"
	/>
			...
			<form id="myform" method="post">
				<table class="gv_table_2">
					<tr>
						...
						<th style="text-align:left; font-weight:bold;">不符合未返款</th>
						<th></th>
					</tr>
				</table>
				...
				<table class="add_table">
				  <tbody id="rebateCondition">
					...
					<table class="gv_table_2">
						<tr>
							<th style="width:20px;"><img src="<ui:img url="/images/title_menu/title_left.gif"/>" /></th>
							<th style="text-align:left; font-weight:bold;">不符合未返款的缴费单</th>
							<th></th>
						</tr>
					</table>
					...
					<page:plugin 
						...
						subStringLength="20"
						searchListActionpath="list_channel_rebate_all_fpd_show_ajax"
						searchCountActionpath="count_channel_rebate_all_fpd_show_ajax"
						columnsStr="createdTime;paymentCode;studentName;branchName;schoolName;academyenrollbatchName;levelName;paymentSubjectName;jiaofeiValue;feeWayId;#status;ceduConfirmTime;isStartCourse;isChannelTypeChecked;#description"
						customColumnValue="0,showtime(createdTime);8,feePaymentCheckedValue(jiaofeiValue);9,feeWayIdValue(feeWayId);10,showstatus(status);11,showtime(ceduConfirmTime);12,showIsStartCourse(isStartCourse,id);13,showIsChannelTypeChecked(isChannelTypeChecked,id);14,showdescription(id,rebateStatus,refundLock,enrollmentSource,status)"
						isPage="true"
