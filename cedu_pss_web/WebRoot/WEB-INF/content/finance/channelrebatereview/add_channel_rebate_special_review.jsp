...
<head>
	...
	<a:ajax 
		...
		urls="/finance/channelrebatereview/sel_fpd_for_channel_rebate_special_review_ajax" 
		pluginCode="120"
	/>
	...
	<a:ajax 
		...
		urls="/finance/channelrebatereview/rem_fpd_for_channel_rebate_special_review_ajax" 
		pluginCode="130"
	/>
	...
	<a:ajax 
		...
		urls="/finance/channelrebatereview/add_channel_rebate_special_review_ajax" 
		pluginCode="140"
	/>
	<!--统计招生返款金额-->
	<a:ajax 
		successCallbackFunctions="ajax_count" 
		parameters="{feepdIds:jQuery('#feepdIds').val(),channelId:jQuery('#oldChannelId').val(),minorChannelIds:jQuery('#mincIds').val(),policeStatus:jQuery('#psta').val()}" 
		urls="/finance/channelrebatereview/count_checked_channel_rebate_review_fpd_special_review_ajax" 
		pluginCode="150"
	/>
			 ...
			 <table class="gv_table_2">
				<tr>
					...
					<page:plugin 
						...
						subStringLength="20"
						searchListActionpath="list_channel_rebate_review_fpd_special_review_ajax"
						searchCountActionpath="count_channel_rebate_review_fpd_special_review_ajax"
						columnsStr="createdTime;paymentCode;channelName;studentName;schoolName;academyenrollbatchName;levelName;paymentSubjectName;jiaofeiValue;feeWayId;#status;ceduConfirmTime;isStartCourse;isChannelTypeChecked;#description"
						customColumnValue="0,showtime(createdTime);8,feePaymentCheckedValue(jiaofeiValue,id);9,feeWayIdValue(feeWayId);10,showstatus(status);11,showtime(ceduConfirmTime);12,showIsStartCourse(isStartCourse,id);13,showIsChannelTypeChecked(isChannelTypeChecked,id);14,showdescription(id,rebateStatus,refundLock,enrollmentSource,status)"
						isPage="true"
						isChecked="true"
						checkboxValue="id"
			...
			<table class="gv_table_2">
				<tr>
					...
					<page:plugin 
						...
						il8nName="finance_payment"
						subStringLength="20"
						searchListActionpath="list_channel_rebate_review_fpd_special_for_now_review_ajax"
						searchCountActionpath="count_channel_rebate_review_fpd_special_for_now_review_ajax"
