...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
				...
				function reportSuccessCallback(data){
					...
					if(data.resultMap.branchList!=null&&data.resultMap.branchList.length!=0){
						...
						for ( var int = 0; int < data.resultMap.branchList.length; int++) {
							...
							if(branch.academy_branch_list!=null&&branch.academy_branch_list.length!=0){
								for ( var int2 = 0; int2 < branch.academy_branch_list.length; int2++) {
									var academy = branch.academy_branch_list[int2];
									theadStr+="<tr>";
										theadStr+="<td align='center'>"+branch.branch_name+"</td>";
										theadStr+="<td align='center'>"+academy.academy_name+"</td>";
										
										theadStr+="<td align='center'>"+academy.academy_zhi_biao+"</td>";
										theadStr+="<td align='center'>"+academy.branch_bao_ming_count+"</td>";
										theadStr+="<td align='center'>"+academy.branch_bao_ming_count_p+"</td>";
										
										theadStr+="<td align='center'>"+academy.branch_lu_qu_count+"</td>";
										theadStr+="<td align='center'>"+academy.branch_no_lu_qu_count+"</td>";
										theadStr+="<td align='center'>"+academy.branch_lu_qu_count_p+"</td>";
										
										theadStr+="<td align='center'>"+academy.branch_jiao_fei_count+"</td>";
										theadStr+="<td align='right'>"+academy.branch_jiao_fei_jin_e+"&nbsp;</td>";
										theadStr+="<td align='center'>"+academy.branch_jiao_fei_count_p+"</td>";
								...
								theadStr+="<tr style='background:#CCFFFF;'>";
										...
										theadStr+="<td align='center'>"+branch.academy_branch_zhi_biao+"</td>";
										theadStr+="<td align='center'>"+branch.academy_branch_bao_ming_count+"</td>";
										theadStr+="<td align='center'>"+branch.academy_branch_bao_ming_count_p+"</td>";
										
										theadStr+="<td align='center'>"+branch.academy_branch_lu_qu_count+"</td>";
										theadStr+="<td align='center'>"+branch.academy_branch_no_lu_qu_count+"</td>";
										theadStr+="<td align='center'>"+branch.academy_branch_lu_qu_count_p+"</td>";
										
										theadStr+="<td align='center'>"+branch.academy_branch_jiao_fei_count+"</td>";
										theadStr+="<td align='right'>"+branch.academy_branch_jiao_fei_jin_e+"&nbsp;</td>";
										theadStr+="<td align='center'>"+branch.academy_branch_jiao_fei_count_p+"</td>";
								...
								theadStr+="<tr style='background-color: red;'>";
										theadStr+="<td align='center'>"+branch.branch_name+"</td>";
										theadStr+="<td colspan='10' align='center' >该中心下没有院校</td>";
								theadStr+="</tr>";
							}
		...
		<a:ajax successCallbackFunctions="reportSuccessCallback" pluginCode="student_source" urls="/report/report_branch_enrollment" parameters="$('#search').serializeObject()" />
		
	</head>
	<body>
	
		<!--头部层开始 -->
		<head:head title="学习中心项目明细表">
		</head:head>
		<!--主体层开始 -->
		<body:body >
			<form id="search" action="<uu:url url="report/excel_export_branch_enrollment" />">
