...
<html xmlns="http://www.w3.org/1999/xhtml">
								...
								for(var k=0;k<xuexiObject.fuwuList.length;k++){
									...
									//if(fuwuObject.userList.length!=0){
										...
										theadStr+=
										   ...
										   +"<td align='center'>"+fuwuObject.fuwuzhanHeJiMap.wangluobaomingCountSum+"</td>"
										   +"<td align='center'>"+fuwuObject.fuwuzhanHeJiMap.wangluobaomingCountPSum+"</td>"
										   +"<td align='center'>"+fuwuObject.fuwuzhanHeJiMap.hujiaozhongxingCountSum+"</td>"
										   +"<td align='center'>"+fuwuObject.fuwuzhanHeJiMap.hujiaozhongxingCountPSum+"</td>"
										   +"<td align='center'>"+fuwuObject.fuwuzhanHeJiMap.xuexizhongxinCountSum+"</td>"
										   +"<td align='center'>"+fuwuObject.fuwuzhanHeJiMap.xuexizhongxinCountPSum+"</td>"
										   +"<td align='center'>"+fuwuObject.fuwuzhanHeJiMap.lishishujuCountSum+"</td>"
										   +"<td align='center'>"+fuwuObject.fuwuzhanHeJiMap.lishishujuCountPSum+"</td>"
	...
	<body>
		...
		<!--头部层开始 -->
		<head:head title="数据来源统计表(总)">
		</head:head>
		<!--主体层开始 -->
		<body:body>
			<form id="search" action="<uu:url url="report/excel_export_student_data_source_general" />">
