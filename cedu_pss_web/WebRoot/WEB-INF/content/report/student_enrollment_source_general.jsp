...
<html xmlns="http://www.w3.org/1999/xhtml">
							...
							for(var j=0;j<quyuObject.xuexiList.length;j++){
								...
								for(var k=0;k<xuexiObject.fuwuList.length;k++){
									...
									//if(fuwuObject.userList.length!=0){
										theadStr+=
											"<tr style=''><td align='center'>"+quyuObject.quyuName+"</td>"
	...
	<body>
		<!--头部层开始 -->
		<head:head title="招生途径统计(总)">
		</head:head>
		<!--主体层开始 -->
		<body:body>
			<form id="search"  action="<uu:url url="report/excel_export_student_enrollment_source_general" />">
