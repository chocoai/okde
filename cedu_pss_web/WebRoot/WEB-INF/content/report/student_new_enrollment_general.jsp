...
<html xmlns="http://www.w3.org/1999/xhtml">
							...
							for(var j=0;j<quyuObject.xuexiList.length;j++){
								...
								for(var k=0;k<xuexiObject.fuwuList.length;k++){
									...
									theadStr+=
									   ...
									   +"<td align='center'>"+fuwuObject.fuwuzhanHeJiMap.dateLuQuCountSum+"</td>"
	...
	<body>
		...
		<!--头部层开始 -->
		<head:head title="新生招生统计表(总)">
		</head:head>
		<!--主体层开始 -->
		<body:body >
			<form id="search" action="<uu:url url="report/excel_export_student_new_enrollment_general" />">
