...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	//提交前的验证
			...
			function insertRelationships(){
 			...
 			var purchaseId=$("#purchaseId").attr("value");
 			//循环获取数组中的物料Id
 				if(number>0){
				...
				if(array.length==0){
					...
					//通过表单实现js post提交
				document.write("<form action='add_meterialpurchasedetail?array="+meterialIds+"&quntion="+quntionIds+"&pric="+arrayprics+"&purchase="+purchaseId+"' method='post' name='lecturerForm' style='display:none'>");
				document.write("</form>");
...
<div id="title_new">
	<div id="contitle">
		<ul id="tags">
			 <li class="selectTag"><a>新增总部采购单</a></li>
		</ul>
	</div>
...
<div class="block">
	<div class="public_table_bg_766">
		...
		<body:body>
		 <form id="form" action="add_meterialpurchasedetail" method="post">
		 <table class="gv_table_2">
		  	<tr>
				 	<th style="width:20px;"><img src="../images/title_left.gif" /></th>
				 	<th style="text-align:left; font-weight:bold;">总部采购单信息</th>
			 </tr>
		  </table>
			<table  class="add_table" >
			<tr>
				<td width="15%"  align="right">采购单编号:</td>
				<td width="85%" align="left"><input type="text" name="purchaseId" id="purchaseId"/><br /></td>
			</tr>
		...
		<table class="gv_table_2">
		  	<tr>
				 	...
				 	<th style="text-align:left; font-weight:bold; width:80px;">采购批量增加</th>
					<th></th>
		...
		<table style="display:none" id="standardTemplate">
			<tbody>
				...
				<td align="left">
					 ...
					 <td align="left">
							  	<select class="txt_box_130" name="meterialname" id="meterialnames">
							  		<option value="0">--请选择--</option>
							  	</select>
					 </td>		
