	...
	<head>
		...
		<script type="text/javascript">
			...
			function org_tree_success_callback(data){
				if(data.treeList!=null&&data.treeList.length!=0){
					$(data.treeList).each(function(){
						...
						if(branch.departments==null||branch.departments.length==0){
							$("#left_tree").html("");
							$("#left_tree").attr("style","display:none;");
							$("#left_tree_right").attr("style","width:100%");
							//return;
						}
	...
	<body>
		...
		<body:body>
			...
			<table width="100%" border="0">
				<tr>
					<td style="width: 12%" valign="top" id="left_tree">
						<fieldset>
							<ul id="adminUserTree" class="ztree"></ul>
							<ul id="branchUserTree" class="ztree"></ul>
						</fieldset>
					</td>
					<td style="width: 88%" valign="top" id="left_tree_right">
