...
<html>
	<head>
 	...
 	<script type="text/javascript" >
		...
		function caozuo(id)
	    {		
			var n='<s:url value="/book/invoicedetail/index_invoice_detail?invoiceid=" />'; 
	  ...
	  <div id="title_new">
		<div id="contitle">
			<ul id="tags">
				 <li class="selectTag"><a class="icon">总部签收</a> </li>
			</ul>
		</div>
		<div id="conmenu">	 
		<img src="../../images/title_menu/icon_add.gif" />
	
		<a href="../invoicedetail/add_invoice_detail" target="_blank">添加发货单</a>
