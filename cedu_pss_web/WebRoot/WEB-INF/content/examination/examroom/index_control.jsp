		   ...
		   <td><input type="button" name="" id="" value="查询" class="btn_black_61"  onclick="search0909()"/>
	    	...
	    	<tbody>
			 <page:plugin 
				...
				columnsStr="examBatchname;examAreaname;inspector;Time;planedCost;actualCost;#summary;#upload"
				customColumnValue="2,showinspector(inspector);3,showtime(startTime,endTime);5,actualcost(id,planedCost,actualCost);6,showsummary();7,showupload()"
