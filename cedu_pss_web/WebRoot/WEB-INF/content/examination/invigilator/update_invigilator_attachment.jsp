...
<html>
  ...
  <body>
     ...
     <form id="form1" action="update_invigilator_attachment" method="post" enctype="multipart/form-data">
		...
		<body:body>
			...
			<table class="add_table">
				...
				<tr>
					...
					<td>
						<input type="text" id="title" name="title" value="${invigilatorattachment.title}"  />
					</td>
				...
				<tr>
					...
					<td><select name="types" id="types" class="txt_box_150">
