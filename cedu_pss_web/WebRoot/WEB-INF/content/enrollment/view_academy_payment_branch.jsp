...
function saveFW()
{
	...
	$.ajax({
		type: 'POST',
		traditional: true,
		url: '<uu:url url="/enrollment/save_branch_payment_way"/>',
		data: {academyId: academyId, batchId: batchId, branchId: branchId, fwIds: fwids},
		dataType: 'json',
		...
		<body:body>
			...
			<table class="gv_table_2">
		  		<tr>
					...
					<th width="30"><input type="checkbox" name="branch" checked="checked" disabled="disabled"/></th>
				</tr>
			</table>
			<table class="add_table" border="0" cellpadding="2" cellspacing="2" id="way_tab">
				<tbody>
					<tr>
						<td width="30"><input type="checkbox" name="branch" value="<s:property value="branch.id"/>" checked="checked" disabled="disabled"/></td>
