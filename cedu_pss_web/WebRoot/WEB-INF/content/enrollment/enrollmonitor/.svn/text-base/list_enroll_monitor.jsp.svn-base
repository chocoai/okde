...
<html>
	<head>
		...
		<script type="text/javascript">
			var status='<%=Constants.STU_CALL_STATUS_YI_DAO_MING %>,<%=Constants.STU_CALL_STATUS_YI_JIAO_CE_SHI_FEI %>,<%=Constants.STU_CALL_STATUS_YI_CE_SHI %>,<%=Constants.STU_CALL_STATUS_YI_FU_HE %>,<%=Constants.STU_CALL_STATUS_YI_LU_QU %>,<%=Constants.STU_CALL_STATUS_YI_JIAO_XUE_FEI %>';
			var jiankongstatus='<%=Constants.STU_MONITOR_STATUS_WEI_JIAN_KONG %>,<%=Constants.STU_MONITOR_STATUS_JIAN_KONG_ZAI_SHENG_QIN %>';
							...
							<tr>
								...
								<td align="left">
									...
									<page:plugin 
										...
										customColumnValue="8,monitorStatusValue(monitorStatus);9,statusValue(status);10,operating(id)"
										searchFormId="search_form"
										view="http,/crm/view_home,studentId,id,_blank"
										params="'student.monitorStatus':-1,'student.statusIds':status,'student.gender':-1,'student.callStatus':-1,'student.monitorStatusIds':jiankongstatus,'student.tuitionStatus':-1"
										isPackage="false"
									/>
