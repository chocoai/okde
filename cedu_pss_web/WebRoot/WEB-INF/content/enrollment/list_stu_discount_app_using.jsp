		...
		<body:body>
			...
			<!--Left Begin-->	
				...
				<page:plugin 
						...
						columnsStr="studentName;gender;branchName;academyName;batchName;levelName;majorName;feeSubjectName;#money;auditee"
						customColumnValue="1,sexValue(gender);8,showmoney(discountWay,money);9,showauditee(auditee)"		
						searchFormId="myform"
					/>
