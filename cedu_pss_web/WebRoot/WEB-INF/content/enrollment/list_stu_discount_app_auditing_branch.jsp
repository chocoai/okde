...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function comoperated(id,status)
			{
				if(status==AUDIT_STATUS_TRUE)
				{
					return "";
				}
		...
		<body:body>
			...
			<!--Left Begin-->	
				...
				<page:plugin 
						...
						columnsStr="studentName;gender;academyName;batchName;levelName;majorName;feeSubjectName;#money;auditStatus;public.operating"
						customColumnValue="1,sexValue(gender);7,showmoney(discountWay,money);8,showstatus(auditStatus);9,comoperated(id,auditStatus)"
