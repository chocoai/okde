		...
		<body:body>
			...
			<!--Left Begin-->	
				...
				<page:plugin 
						...
						columnsStr="studentName;gender;academyName;batchName;levelName;majorName;feeSubjectName;#money;auditStatus"
						customColumnValue="1,sexValue(gender);7,showmoney(discountWay,money);8,showstatus(auditStatus)"		
						searchFormId="myform"
					/>
