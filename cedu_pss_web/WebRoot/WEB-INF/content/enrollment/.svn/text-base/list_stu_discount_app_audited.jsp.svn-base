		...
		<body:body>
			...
			<!--Left Begin-->	
				...
				<table class="add_table">
					<tr>
	             	...
	             	<tr>
	             		<td colspan="7"></td>
	             		<td align="left">
	             			<input type="hidden" name="discountApplication.usageFlag" id="usageFlag" value="<%=Constants.POLICY_USING_STATUS_FALSE %>"/>
				...
				<page:plugin 
						...
						columnsStr="studentName;gender;branchName;academyName;batchName;levelName;majorName;feeSubjectName;#money;auditStatus;auditee"
						customColumnValue="1,sexValue(gender);8,showmoney(discountWay,money);9,showstatus(auditStatus);10,showauditee(auditee)"		
						searchFormId="myform"
					/>
