		...
		<script type="text/javascript">
			...
			*/
			function operating(id,aduitstatus)
			{
				...
				{
					return '<a href="'+WEB_PATH+'/enrollment/view_channel?id='+id+'" ><img src="'+WEB_IMAGES+'/images/icon_view.gif"/></a><a href="'+WEB_PATH+'/enrollment/modify_channel?actionResult=copy&id='+id+'" ><img src="'+WEB_IMAGES+'/images/icon_edit.gif"/></a><a href="javascript:void(0)" onclick="deleteFun('+id+')" ><img src="'+WEB_IMAGES+'/images/icon_del.gif"/></a>';
				}
