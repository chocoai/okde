...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	function valid()
	{
		if($(':radio[name=auditStatus]:checked').size()==0)
				return false;
  ...
  <body>
<form onsubmit="return valid()" action="<uu:url url="/enrollment/academyrebatepolicy/modify_academy_rebate_policy_detail_audit_status" />" method="post">
		<!--头部层开始 -->
		...
		<body:body>
		  ...
		  <table class="add_table"><tr><td align="center">
		  	<input type="radio" name="auditStatus" value="<s:property value="@net.cedu.common.Constants@POLICY_AUDIT_STATUS_GOOD" />"/>通过
		  	&nbsp;&nbsp;
		  	<input type="radio" name="auditStatus" value="<s:property value="@net.cedu.common.Constants@POLICY_AUDIT_STATUS_BAD" />"/>不通过
		  	&nbsp;&nbsp;&nbsp;
		  	<input class="btn_black_61" type="submit" value="提交" onclick="void(0)"/>
		  </td></tr></table>
		</body:body>
	<input type="hidden" value="${ param.detailId }" name="detailId"/>
</form>
  </body>
</html>
