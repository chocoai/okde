...
<html xmlns="http://www.w3.org/1999/xhtml" >
	<head>
		...
		<script type="text/javascript">
			...
			//	var lists="";
			//		lists+= "<div class='righttxt' title=''><span style='vertical-align:middle;'><img border='0' src='<ui:img url="images/wait.gif"/>' />  </span><a class='headmessage' href='<uu:url url="base/task" />' target='main'><font class='headmessage' id='messageCountB'>下载任务"
			//				 +"("+0+")</font>"
			//				 +"</a></div>";
			//		document.getElementById("visitorChatPanl").innerHTML=lists;
				var lists_="";
					lists_+= "<div class='righttxt1' title=''><a class='headmessage' href='<uu:url url="worklog/add_worklog" />' target='main'><font class='headmessage' id='messageCountB'>今天您还没有写日报哦！</font></a></div>";
					lists_+="";
					//document.getElementById("messagePanl").innerHTML=lists_;
			});
			function task_count_callback(data)
			{
				var lists="";
				if(data.finishCount>0)
				{
					lists+= "<div class='righttxt1' title=''><span style='vertical-align:middle;'><img border='0' src='<ui:img url="images/wait.gif"/>' />  </span><a class='headmessage' href='<uu:url url="base/task" />' target='main'><font class='headmessage' id='messageCountB'>下载任务"
							 +"("+data.finishCount+")</font>"
							 +"</a></div>";
					document.getElementById("visitorChatPanl").innerHTML=lists;
				}
				else
		...
		<a:ajax successCallbackFunctions="task_count_callback" pluginCode="100" urls="/base/finish_base_task_count"/>
</head>
	  			...
	  			<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
	  				<tr>
			  			<td width="460" align="left">
			  				<img src="<s:url value="/plugin/base_css/images/logolong.gif" />" style="float: left; margin-left: 0px;" />
			  			</td>
			  			<td>
