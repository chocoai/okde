	...
	<div class=listbox style="margin-left: 8px;margin-top: 2px;">
			...
			<div class=boxline>
				<div class=main_jsmes>
					<div class=div_main>
						<iframe width="100%" height="655px"  frameborder="0" id="home_sch" name="home_sch" marginheight="0" marginwidth="0" src="<%=Constants.WEB_PATH %>/academy/school_calendar_view_home" target="_self" allowtransparency="true"></iframe>
					</div>
				</div>
			</div>
	</div>
