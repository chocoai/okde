...
<html>
	<head>
		...
		<a:ajax 
			...
			urls="/crm/export/excel_export_list_manager_student"
		/>
	</head>
	<body>
		<!--头部层开始 -->
		<head:head title="学生信息查询">
		</head:head>
		<!--主体层开始 -->
		<body:body>
				<form id="search_form">
					<table class="add_table" cellpadding="2" cellspacing="2">
						...
						<tr>
							...
							<tr>
								...
								<td align="right">呼叫等级：</td>
								<td align="left">
									<select id="callStatusId" class="txt_box_130" name="student.callStatusId">
										<option value="0">
											请选择呼叫等级
										</option>
							...
							<tr>
								...
								<td align="left">
									...
									<page:plugin 
										...
										columnsStr="name;certNo;status;gender;schoolName;academyenrollbatchName;levelName;majorName;paramsString.firstFollowUpUser;paramsString.firstFollowUpTime;followUpName"
										customColumnValue="2,statusValue(status);3,sexValue(gender)"
										pageSize="10"
