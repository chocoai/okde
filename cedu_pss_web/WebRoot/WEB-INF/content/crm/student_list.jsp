	...
	<head>
		...
		<script type="text/javascript">
			...
			<a:ajax 
				...
				urls="/crm/export/excel_export_list_student"
			/>
			<script type="text/javascript">
					$(document).ready(function(){
						//加载学生状态
							...
							<tr>
								...
								<td align="left">
									...
									<page:plugin 
										...
										columnsStr="name;certNo;status;gender;branchName;schoolName;academyenrollbatchName;levelName;majorName;followUpName"
										...
										update="http,/crm/update_studentinfo,studentId,id,_blank"
