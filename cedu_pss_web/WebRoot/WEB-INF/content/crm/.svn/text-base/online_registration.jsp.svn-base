...
<html>
	<head>
		...
		<a:ajax 
			...
			urls="/crm/export/excel_export_online_yi_tui_song_student"
		/>
						...
						<tr>
							...
							<tr>
								...
								<td align="left">
									...
									<input  id="export_student_data_btn" style="display: none;" type="button" class="btn_black_61" onclick="download();" value="导出"/>
									...
									<page:plugin 
										...
										params="'student.callStatus':-1,'student.status':STU_CALL_STATUS_YU_BAO_MING,'student.studentDataSource':STU_SOURCE_NP"
									/>
									<page:plugin 
										isonLoad="false"
										pluginCode="002"
										...
										update="http,/crm/call_home,studentId,id,_blank"
										searchFormId="search_form"
										params="'student.callStatus':-1,'student.status':STU_CALL_STATUS_WU_YI_YUAN_CHUSHI,'student.studentDataSource':STU_SOURCE_NP"
									/>
									<page:plugin 
										pluginCode="003"
										isonLoad="false"
										...
										searchFormId="search_form"
										view="http,/crm/view_home,studentId,id,_blank"
										params="'student.callStatus':-1,'student.startStatusId':STU_CALL_STATUS_YU_BAO_MING,'student.endStatusId':STU_CALL_STATUS_WU_YI_YUAN_CHUSHI,'student.studentDataSource':STU_SOURCE_NP"
