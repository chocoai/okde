...
<html>
	...
	<body>
		...
		<body:body>
						...
						<s:select list="#request.academys" name="schoolId" id="schoolId" cssClass="txt_box_200" listKey="id" cssStyle="display:none;" listValue="name"  theme="simple"/>
			</body:body>
	</body>
